...
public class WarGame
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("When the cards have the same value, it's time for WAR!"
		...
		while (!gameOver)
		{
			...
			System.out
					.print("Press any key to keep playing, or 'Q' to call a truce.");

			if (keyboard.next().equalsIgnoreCase("q"))
			{
				gameOver = true;
				System.out
						.println("A truce has been called! Thank you for playing WAR!");
				keyboard.close();
			}
		}
	}
	...
	{
		String[] warASCII = { " _    _  ___  ______ ", "| |  | |/ _ \\ | ___ \\",
				"| |  | / /_\\ \\| |_/ /", "| |/\\| |  _  ||    /",
				"\\  /\\  / | | || |\\ \\ ", " \\/  \\/\\_| |_/\\_| \\_|" };
