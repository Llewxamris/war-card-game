...
public class War {
    ...
    War() {
        ...
        player1 = "Unknown";
        player2 = "Unknown";
        start(); // Call start to shuffle the cards and distribute the cards
    ...
    private void start() {
        /*
         * Calls the shuffle method in deckOfCards to shuffle the deck. Takes
         * the Deck object deckOfCards and distributes the Card objects within
         * to the *Hand queues.
         */
        ...
        addToOutput(
                "Both players have " + player1Hand.size() + " cards to start.");
        addToOutput("\nIT IS TIME, FOR WAR!");
        addToOutput("--------------------");
    ...
    protected String play() {
        /*
         * Runs through a round of play, dealing with winning, losing, gaining
         * or losing cards, and with WAR
         */
        ...
        addToOutput(
                getPlayer1() + " has " + player1Hand.size() + " cards left.");
        addToOutput(
                getPlayer2() + " has " + player2Hand.size() + " cards left.");
        winnersPot.clear();
